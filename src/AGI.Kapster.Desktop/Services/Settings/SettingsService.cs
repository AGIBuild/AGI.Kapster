...
public class SettingsService : ISettingsService
{
    ...
    private void MergeSettings(AppSettings baseSettings, AppSettings userSettings)
    {
        ...
        // AutoUpdate settings
        if (userSettings.AutoUpdate != null)
        {
            baseSettings.AutoUpdate = userSettings.AutoUpdate;
        }
    }
    ...
    /// <summary>
    /// Synchronous save for constructor use
    /// </summary>
    private void SaveSettingsSync(AppSettings settings)
    {
        try
        {
            ...
            // Write synchronously
            using var stream = _fileSystemService.CreateFileStream(_settingsFilePath, FileMode.Create, FileAccess.Write, FileShare.Read);
