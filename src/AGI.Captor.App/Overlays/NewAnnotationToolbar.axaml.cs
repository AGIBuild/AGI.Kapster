...
public partial class NewAnnotationToolbar : UserControl
{
    ...
    private void SetupToolButtons()
    {
        ...
        _toolButtons.Add(this.FindControl<ToggleButton>("EmojiToolButton")!);
    ...
    private void OnToolButtonClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        ...
        if (this.FindControl<StackPanel>("EmojiPanel") is { } emojiPanel)
        {
            emojiPanel.IsVisible = toolType == AnnotationToolType.Emoji;
        }
    ...
    private void SetupSliders()
    {
        ...
        {
            widthSlider.ValueChanged += (_, __) =>
            {
                var value = (int)widthSlider.Value;
        ...
        {
            fontSlider.ValueChanged += (_, __) =>
            {
                var value = (int)fontSlider.Value;
    ...
    public void SetTarget(NewAnnotationOverlay target)
    {
        ...
        // Initialize UI state based on target
        if (target != null)
        {
            UpdateUIFromTarget();
        }
    ...
    public void UpdateUIFromTarget()
    {
        ...
        _currentColor = Target.CurrentStyle.StrokeColor;
        UpdateCurrentColorDisplay();
        ...
        if (this.FindControl<Slider>("WidthSlider") is { } widthSlider &&
            this.FindControl<TextBlock>("WidthValueText") is { } widthText)
        {
            var width = (int)Target.CurrentStyle.StrokeWidth;
        ...
        if (this.FindControl<Slider>("FontSizeSlider") is { } fontSlider &&
            this.FindControl<TextBlock>("FontSizeValueText") is { } fontText)
        {
            var fontSize = (int)Target.CurrentStyle.FontSize;
        ...
        if (this.FindControl<StackPanel>("EmojiPanel") is { } emojiPanel)
        {
            bool wasVisible = emojiPanel.IsVisible;
            emojiPanel.IsVisible = Target.CurrentTool == AnnotationToolType.Emoji;
            if (wasVisible != emojiPanel.IsVisible) layoutChanged = true;
        }
